  ...
  return (
    <div className="rounded-xl border border-gray-800 bg-gray-900 p-6 shadow-md">
      ...
      <div className="mt-4 grid gap-2 md:grid-cols-3">
        <input className="border border-gray-300 rounded-lg px-3 py-2 bg-gray-950" placeholder="Filter issuer" value={filterIssuer} onChange={(e) => setFilterIssuer(e.target.value)} />
        <input className="border border-gray-300 rounded-lg px-3 py-2 bg-gray-950" placeholder="Filter domain" value={filterDomain} onChange={(e) => setFilterDomain(e.target.value)} />
        <input className="border border-gray-300 rounded-lg px-3 py-2 bg-gray-950" placeholder="Filter status" value={filterStatus} onChange={(e) => setFilterStatus(e.target.value)} />
      </div>
