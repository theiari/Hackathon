  ...
  return (
    <div className={`rounded-lg border border-gray-700 bg-gray-950/40 p-4 ${className ?? ""}`}>
      <div className="flex flex-wrap items-center justify-between gap-2">
        <h4 className="text-lg font-semibold text-white">{metadata.credential_type || "Certificate"}</h4>
      ...
      {Object.keys(publicFields).length > 0 && (
        <div className="mt-3">
          <p className="text-sm font-semibold text-gray-100">📋 Certificate Details</p>
